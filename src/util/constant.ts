...
const NEXT_PUBLIC_AWS_SECRET_ACCESS_KEY = process.env
  .NEXT_PUBLIC_AWS_SECRET_ACCESS_KEY as string
const NEXT_PUBLIC_AWS_ACCESS_KEY_ID = process.env
  .NEXT_PUBLIC_AWS_ACCESS_KEY_ID as string
const NEXT_PUBLIC_AWS_REGION = process.env.NEXT_PUBLIC_AWS_REGION as string
