...
import ButtonIcon from "@/src/components/ui/typography/ButtonIcon/page"
    ...
    <section className="md:py-20 pt-10 pb-20">
      <Container>
        <div className="flex items-center justify-center flex-col mb-20">
          ...
          <h3 className="font-bold text-4xl text-black dark:text-white mt-2">
            Why Choose Us?
          </h3>
        </div>
            ...
            (data: {
              ...
              return (
                ...
                >
                  <ButtonIcon
                    variant="outline"
                    className="!text-xl !h-12 !w-12 text-black"
                  >
                    {data.icon}
                  </ButtonIcon>
                  <div className="body">
