...
const Textarea: React.FC<TextareaProps> = ({
  ...
  return (
    <textarea
      ...
      rows={rows}
      cols={cols}
      className={`w-full border border-gray-300 py-3 pl-3 rounded-md mt-2 shadow-sm outline-none focus:outline-none focus:ring-color2 focus:border-color2 transition-all hover:transition-all dark:bg-gray-700 dark:border-gray-500 ${className}`}
