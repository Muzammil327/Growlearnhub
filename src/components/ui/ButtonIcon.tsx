...
export default function ButtonIcon({
  ...
  return (
    <button
      ...
      outline-none flex rounded-md shadow-sm sm:text-base text-sm font-medium focus:outline-none duration-500 ease-in-out cursor-pointer h-10 w-10 p-2 mr-5 disabled:cursor-not-allowed transition-all 
