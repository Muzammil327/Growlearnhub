...
import { Class12_Book } from '@/src/app/books/class-12/data'
import Link from 'next/link'

const data = {
  title: 'Class 12 Books || GrowLearnHub',
  description:
    'Here you can access class 12 books in english and urdu medium of all subjects like physics, chemistry biology and math available in this website.',
...
export default function page() {
  return (
    ...
    >
      <p>
        Are you looking for a <strong>Class 12 book</strong>? Here, you can
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 12 Book of all Subjects"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      {Class12_Book.map((data: class_Book) => {
        return (
          <div key={data.name}>
            <h2 className="text-xl font-semibold py-2">
              {data.name} Class 12 Textbooks
            </h2>
            <p>
              Our collection of <strong>Class 12 Textbooks</strong> of Punjab
      ...
      <div>
        <h2>Additional Resources Class 12</h2>
        <ul>
          <li>
            <Link href="/notes/">Class 12 Subject Notes:</Link> Detailed notes
            for each subject to help you grasp and review important concepts.
          </li>
          <li>
            <Link href="/pairing-schemes/">12th Class Pairing Schemes:</Link>{' '}
            Guides to help you focus on the most crucial topics for your exams.
          </li>
          <li>
            Class 12 Online MCQ Tests: Practice tests to assess your knowledge
