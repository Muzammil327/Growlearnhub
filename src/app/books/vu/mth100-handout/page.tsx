...
const data = {
  title: "MTH100 Handouts General Mathematics",
  description:
    "Here you can download Handouts OF MTH100 General Mathematics of vu of all semester cs101, cs201, cs301, cs401 etc.",
  canonical: "/books/vu/mth100-handout/",
  index: true,
  follow: true,
  image: "/opengraph-image.jpg",
  url: "https://growlearnhub.com/books/vu/mth100-handout/",
  keywords: [
    ...
    "vu mth100 books",
    "vu mth100 handouts",
    "download mth100 handouts",
    "download vu mth100 handouts",
  ],
  list: [
    {
      id: 0,
