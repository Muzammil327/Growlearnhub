...
const data = {
  title: "PAK301 Handouts Pakistan Studies",
  description:
    "Here you can download Handouts OF PAK301 Pakistan Studies of vu of all semester cs101, cs201, cs301, cs401 etc.",
  canonical: "/books/vu/pak301-handout/",
  index: true,
  follow: true,
  image: "/opengraph-image.jpg",
  url: "https://growlearnhub.com/books/vu/pak301-handout/",
  keywords: [
    ...
    "vu pak301 books",
    "vu pak301 handouts",
    "download pak301 handouts",
    "download vu pak301 handouts",
  ],
  list: [
    {
      id: 0,
