...
const data = {
  title: "PHY101 Handouts Physics",
  description:
    "Here you can download Handouts OF PHY101 Physics of vu of all semester cs101, cs201, cs301, cs401 etc.",
  canonical: "/books/vu/phy101-handout/",
  index: true,
  follow: true,
  image: "/opengraph-image.jpg",
  url: "https://growlearnhub.com/books/vu/phy101-handout/",
  keywords: [
    ...
    "vu phy101 books",
    "vu phy101 handouts",
    "download phy101 handouts",
    "download vu phy101 handouts",
  ],
  list: [
    {
      id: 0,
