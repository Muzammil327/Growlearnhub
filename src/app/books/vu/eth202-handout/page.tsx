...
const data = {
  title: "ETH202 Handouts Ethics (For Non-Muslims)",
  description:
    "Here you can download Handouts OF ETH202 Ethics (For Non-Muslims) of vu of all semester cs101, cs201, cs301, cs401 etc.",
  canonical: "/books/vu/eth202-handout/",
  index: true,
  follow: true,
  image: "/opengraph-image.jpg",
  url: "https://growlearnhub.com/books/vu/eth202-handout/",
  keywords: [
    ...
    "vu eth202 books",
    "vu eth202 handouts",
    "download eth202 handouts",
    "download vu eth202 handouts",
  ],
  list: [
    {
      id: 0,
