...
const data = {
  title: 'Class 10 Ikhlaqiat Book Punjab Board',
  description:
    'Here you can access class 10 Ikhlaqiat Book Punjab Board in urdu medium available in this website.',
  ...
  keywords: [
    ...
    '10 class book Ikhlaqiat',
    'class 10th Ikhlaqiat book pdf',
    'class 10 Ikhlaqiat pdf',
    'class ten Ikhlaqiat book',
    '10th class Ikhlaqiat book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Ikhlaqiat Book of Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h3>Download 10th Class Ikhlaqiat Textbook Punjab Board</h3>
      <p>
