...
const data = {
  ...
  description:
    'Here you can access class 10 Computer Science Book Punjab Board in english and urdu medium available in this website.',
  ...
  keywords: [
    ...
    '10 class book computer science',
    'class 10th computer science book pdf',
    'class 10 computer science pdf',
    'class ten computer science book',
  ...
  return (
    ...
    >
      <p>
        ...
        <strong>Class 10 Computer Science book punjab board</strong>? Here, you can
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Computer Science Book of english and Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download Class 10 Computer Science Book English Medium Punjab Board</h2>
      <p>
        Here, you can download Matric class 10 Computer Science Text Book in PDF Format
        for English Medium. This book is officially published by Punjab Text
        Book Board.
      </p>
      <PDFViewer pdfUrl={data.english_medium} />

      <h3>Download 10th Class Computer Science Textbook Urdu Medium Punjab Board</h3>
      <p>
        Here, you can download Matric class 10 Computer Science Text Book in PDF Format
