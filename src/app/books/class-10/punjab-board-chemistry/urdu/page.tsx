...
const data = {
  title: "Class 10 Urdu Medium Chemistry Book Punjab Board",
  description:
    "Here you can download Class 10 Chemistry Book Punjab Board in urdu medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-chemistry/urdu/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-chemistry/urdu/",
  urdu_medium: "1oXj4uREnP4i8CnwYyemPaQn-kbaJhuRw",
  keywords: [
    "growlearnhub class 10 chemistry books urdu medium",
    "growlearnhub class 10 books chemistry urdu medium",
    "class 10 chemistry book urdu medium",
    "class 10 chemistry urdu medium",
    "class 10 chemistry book urdu medium",
    "class 10 book chemistry urdu medium",
    "download class 10 book chemistry urdu medium",
  ],
};
