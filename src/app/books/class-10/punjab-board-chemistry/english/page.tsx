...
const data = {
  title: "Class 10 English Medium Chemistry Book Punjab Board",
  description:
    "Here you can download Class 10 Chemistry Book Punjab Board in english medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-chemistry/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-chemistry/english/",
  english_medium: "1pn0Jh5fM8QLFKGeNSdwBwJQmyzHtXoEZ",
  keywords: [
    "growlearnhub class 10 chemistry books english medium",
    "growlearnhub class 10 books chemistry english medium",
    "class 10 chemistry book english medium",
    "class 10 chemistry english medium",
    "class 10 chemistry book english medium",
    "class 10 book chemistry english medium",
    "download class 10 book chemistry english medium",
  ],
};
...
export default function page() {
  return (
    <BookWrapper
      ...
      b3Link="/books/class-10/punjab-board-chemistry/"
      b4="English Medium"
    >
      <p>
