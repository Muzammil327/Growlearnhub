...
const data = {
  ...
  description:
    'Here you can access class 10 Biology Book Punjab Board in english and urdu medium available in this website.',
  ...
  keywords: [
    ...
    '10 class book biology',
    'class 10th biology book pdf',
    'class 10 biology pdf',
    'class ten biology book',
    '10th class biology book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Biology Book of english and Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download Class 10 Biology Book English Medium Punjab Board</h2>
      <p>
