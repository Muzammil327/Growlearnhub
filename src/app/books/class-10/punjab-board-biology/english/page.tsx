...
const data = {
  title: "Class 10 English Medium Biology Book Punjab Board",
  description:
    "Here you can download Class 10 Biology Book Punjab Board in english medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-biology/english/",
  index: true,
  follow: true,
  ...
  keywords: [
    "growlearnhub class 10 biology books english medium",
    "growlearnhub class 10 books biology english medium",
    "class 10 biology book english medium",
    "class 10 biology english medium",
    "class 10 biology book english medium",
    "class 10 book biology english medium",
    "download class 10 book biology english medium",
  ],
};
