...
const data = {
  title: 'Class 10 Islamiat Book Punjab Board',
  description:
    'Here you can access class 10 Islamiat Book Punjab Board in urdu medium available in this website.',
  canonical: '/books/class-10/punjab-board-islamiat/',
  index: true,
  follow: true,
  image: '/books/class-10/punjab/class-10-Islamiat-book-punjab-board.webp',
  url: 'https://growlearnhub.com/books/class-10/punjab-board-islamiat/',
  urdu_medium: '1wIy4qZhIYLW4VOeNeka_QHVtbgVBMBEj',
  keywords: [
    'Islamiat class 10',
    'class 10 Islamiat book',
    '10 class book Islamiat',
    'class 10th Islamiat book pdf',
    'class 10 Islamiat pdf',
    'class ten Islamiat book',
    '10th class Islamiat book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Islamiat Book of Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h3>Download 10th Class Islamiat Textbook Punjab Board</h3>
      <p>
