...
const data = {
  title: 'Class 10 Tarjuma Tul Quran Book Punjab Board',
  description:
    'Here you can access class 10 Tarjuma Tul Quran Book Punjab Board in urdu medium available in this website.',
  ...
  keywords: [
    'Tarjuma Tul Quran class 10',
    'class 10 Tarjuma Tul Quran book',
    '10 class book Tarjuma Tul Quran',
    'class 10th Tarjuma Tul Quran book pdf',
    'class 10 Tarjuma Tul Quran pdf',
    'class ten Tarjuma Tul Quran book',
    '10th class Tarjuma Tul Quran book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Tarjuma Tul Quran Book of Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h3>
        Download 10th Class Tarjuma Tul Quran Textbook Urdu Medium Punjab Board
      </h3>
      <p>
        Here, you can download Matric class 10 Tarjuma Tul Quran Text Book in
        PDF Format for Urdu Medium. This book is officially published by Punjab
        Text Book Board.
      </p>
