...
const data = {
  ...
  description:
    'Here you can access class 10 Pak Study Book Punjab Board in english and urdu medium available in this website.',
  canonical: '/books/class-10/punjab-board-pak-study/',
  index: true,
  follow: true,
  image: '/books/class-10/punjab/class-10-pak-study-book-punjab-board.webp',
  ...
  keywords: [
    ...
    '10 class book Pak Study',
    'class 10th Pak Study book pdf',
    'class 10 Pak Study pdf',
    'class ten Pak Study book',
    '10th class Pak Study book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Pak Study Book of english and Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download Class 10 Pak Study Book English Medium Punjab Board</h2>
      <p>
