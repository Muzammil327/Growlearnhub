...
const data = {
  title: "Class 10 English Medium Pak Study Book Punjab Board",
  description:
    "Here you can download Class 10 Pak Study Book Punjab Board in english medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-pak-study/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-biology/english/",
  english_medium: "1OxabDGzPSag12NTwLY_daJIBcvrsXF8C",
  keywords: [
    "growlearnhub class 10 Pak Study books english medium",
    "growlearnhub class 10 books Pak Study english medium",
    "class 10 Pak Study book english medium",
    "class 10 Pak Study english medium",
    "class 10 Pak Study book english medium",
    "class 10 book Pak Study english medium",
    "download class 10 book Pak Study english medium",
  ],
};
