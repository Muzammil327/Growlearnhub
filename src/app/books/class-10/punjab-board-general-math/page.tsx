...
const data = {
  ...
  description:
    'Here you can access class 10 General Math Book Punjab Board in english and urdu medium available in this website.',
  ...
  keywords: [
    ...
    '10 class book General Math',
    'class 10th General Math book pdf',
    'class 10 General Math pdf',
    'class ten General Math book',
    '10th class General Math book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 General Math Book of english and Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download Class 10 General Math Book English Medium Punjab Board</h2>
      <p>
