...
const data = {
  title: "Class 10 General Math Book Punjab Board",
  description:
    "Here you can download Class 10 General Math Book Punjab Board in english and urdu medium. other books of class 10 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 10 General Math books",
    "growlearnhub class 10 books General Math",
    "class 10 General Math",
    "class 10 General Math english medium",
    "class 10 General Math urdu medium",
    "class 10 General Math book",
    "class 10 book General Math",
    "download class 10 book General Math",
  ],
  medium: [
    {
      title: "Class 10 General Math Punjab Board English Medium Book",
      link: "/books/class-10/punjab-board-general-math/english/",
      description: "",
      image: "",
    },
    {
      title: "Class 10 General Math Punjab Board Urdu Medium Book",
      link: "/books/class-10/punjab-board-general-math/urdu/",
      description: "",
      image: "",
    },
  ],
...
export default function page() {
  return (
    ...
    >
      ...
      <h2>Download Class 10 English Medium Gneral Math Punjab Board</h2>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
      ...
      <h3>Download Class 10 Urdu Medium Gneral Math Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
