...
const data = {
  title: "Class 10 English Medium General Math Book Punjab Board",
  description:
    "Here you can download Class 10 General Math Book Punjab Board in english medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-general-math/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-general-math/english/",
  english_medium: "1-IgbSZLLzcL_X6Bo8OTpz3E1s-r-r_cM",
  keywords: [
    "growlearnhub class 10 General Math books english medium",
    "growlearnhub class 10 books General Math english medium",
    "class 10 General Math book english medium",
    "class 10 General Math english medium",
    "class 10 General Math book english medium",
    "class 10 book General Math english medium",
    "download class 10 book General Math english medium",
  ],
};
...
export default function page() {
  return (
    <BookWrapper
      ...
      b3Link="/books/class-10/punjab-board-general-math/"
      b4="English Medium"
    >
      <p>
      ...
      <h2>Download Class 10 English Medium General Math Punjab Board</h2>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
