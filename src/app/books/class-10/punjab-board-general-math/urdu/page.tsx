...
const data = {
  title: "Class 10 English Urdu Medium General Math Book Punjab Board",
  description:
    "Here you can download Class 10 General Math Book Punjab Board in urdu medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-general-math/urdu/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-general-math/urdu/",
  urdu_medium: "1ECltNF6D25sdWg-_j0tXNWA0QiGDyFC1",
  keywords: [
    "growlearnhub class 10 General Math books urdu medium",
    "growlearnhub class 10 books General Math urdu medium",
    "class 10 General Math book urdu medium",
    "class 10 General Math urdu medium",
    "class 10 General Math book urdu medium",
    "class 10 book General Math urdu medium",
    "download class 10 book General Math urdu medium",
  ],
};
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 10 Urdu Urdu General Math Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
