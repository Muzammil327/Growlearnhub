...
const data = {
  title: "Class 10 Urdu Book Punjab Board",
  description:
    "Here you can download Class 10 urdu Book Punjab Board in urdu medium. other books of class 10 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 10 urdu books",
    "growlearnhub class 10 books urdu",
    "class 10 urdu",
    "class 10 urdu english medium",
    "class 10 urdu urdu medium",
    "class 10 urdu book",
    "class 10 book urdu",
    "download class 10 book urdu",
  ],
};
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 10 Urdu Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
