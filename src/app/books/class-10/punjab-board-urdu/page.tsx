...
const data = {
  ...
  description:
    'Here you can access class 10 Urdu Book Punjab Board in urdu medium available in this website.',
  ...
  keywords: [
    ...
    'class 10 Urdu book',
    '10 class book Urdu',
    'class 10th Urdu book pdf',
    'class 10 Urdu pdf',
    'class ten Urdu book',
    '10th class Urdu book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Urdu Book of Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h3>Download 10th Class Urdu Textbook Punjab Board</h3>
      <p>
        Here, you can download Matric class 10 Urdu Text Book in PDF Format for
