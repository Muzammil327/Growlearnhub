...
const data = {
  title: "Class 10 English Urdu Medium Math Book Punjab Board",
  description:
    "Here you can download Class 10 Math Book Punjab Board in urdu medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-math/urdu/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-math/urdu/",
  urdu_medium: "1-Xk0nSa02Dr9SE1Ep7gbUAqjkZ7lYOZr",
  keywords: [
    "growlearnhub class 10 math books urdu medium",
    "growlearnhub class 10 books math urdu medium",
    "class 10 math book urdu medium",
    "class 10 math urdu medium",
    "class 10 math book urdu medium",
    "class 10 book math urdu medium",
    "download class 10 book math urdu medium",
  ],
};
