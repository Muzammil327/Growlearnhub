...
const data = {
  title: "Class 10 English Medium Math Book Punjab Board",
  description:
    "Here you can download Class 10 math Book Punjab Board in english medium. other books of class 10 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-math/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-math/english/",
  english_medium: "1Wx5FABJn6wG8MI3Zy_VvDb-iEIRucNMb",
  keywords: [
    "growlearnhub class 10 math books english medium",
    "growlearnhub class 10 books math english medium",
    "class 10 math book english medium",
    "class 10 math english medium",
    "class 10 math book english medium",
    "class 10 book math english medium",
    "download class 10 book math english medium",
  ],
};
...
export default function page() {
  return (
    <BookWrapper
      ...
      b3Link="/books/class-10/punjab-board-math/"
      b4="English Medium"
    >
      <p>
