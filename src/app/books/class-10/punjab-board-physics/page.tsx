...
const data = {
  ...
  description:
    'Here you can access class 10 Physics Book Punjab Board in english and urdu medium available in this website.',
  ...
  keywords: [
    ...
    '10 class book physics',
    'class 10th physics book pdf',
    'class 10 physics pdf',
    'class ten physics book',
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 10 Physics Book of english and Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download Class 10 Physics Book English Medium Punjab Board</h2>
      <p>
