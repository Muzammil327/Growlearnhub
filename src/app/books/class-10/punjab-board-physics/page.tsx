...
const data = {
  title: "Class 10 Physics Book Punjab Board",
  description:
    "Here you can download Class 10 Physics Book Punjab Board in english and urdu medium. other books of class 10 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 10 physics books",
    "growlearnhub class 10 books physics",
    "class 10 physics",
    "class 10 physics english medium",
    "class 10 physics urdu medium",
    "class 10 physics book",
    "class 10 book physics",
    "download class 10 book physics",
  ],
  medium: [
    {
      title: "Class 10 Physics Punjab Board English Medium Book",
      link: "/books/class-10/punjab-board-physics/english/",
      description: "",
      image: "",
    },
    {
      title: "Class 10 Physics Punjab Board Urdu Medium Book",
      link: "/books/class-10/punjab-board-physics/urdu/",
      description: "",
      image: "",
    },
  ],
...
export default function page() {
  return (
    ...
    >
      ...
      <h2>Download Class 10 English Medium Physics Punjab Board</h2>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
      ...
      <h3>Download Class 10 Urdu Medium Physics Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
