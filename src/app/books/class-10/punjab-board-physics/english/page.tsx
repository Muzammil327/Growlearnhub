...
const data = {
  title: "Class 10 English Medium Physics Book Punjab Board",
  description:
    "Here you can download Class 10 Physics Book Punjab Board in english medium. other books of class 9 punjab board available in this platform.",
  canonical: "/books/class-10/punjab-board-physics/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-10/punjab-board-physics/english/",
  english_medium: "1w4B4C1PmS6pB2iWTh1K9EQf_HAG8Ohsx",
  keywords: [
    "growlearnhub class 10 Physics books english medium",
    "growlearnhub class 10 books Physics english medium",
    "class 10 Physics book english medium",
    "class 10 Physics english medium",
    "class 10 Physics book english medium",
    "class 10 book Physics english medium",
    "download class 10 book Physics english medium",
  ],
};
