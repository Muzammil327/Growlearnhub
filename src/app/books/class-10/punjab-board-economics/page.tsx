...
const data = {
  title: "Download Class 10 Economics Book Punjab Board",
  description:
    "Here you can download Class 10 Economics Book Punjab Board. Other books of class 10 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 10 Economics books",
    "growlearnhub class 10 books Economics",
    "class 10 Economics",
    "class 10 Economics english medium",
    "class 10 Economics Economics medium",
    "class 10 Economics book",
    "class 10 book Economics",
    "download class 10 book Economics",
  ],
};
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 10 Economics Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
