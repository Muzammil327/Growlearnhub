...
const data = {
  ...
  description:
    'Here you can access class 9 urdu Book Punjab Board in english and urdu medium available in this website.',
  canonical: '/books/class-9/punjab-board-urdu/',
  index: true,
  follow: true,
  image: '/books/class-9/punjab/class-9-urdu-book-punjab-board.webp',
  ...
  keywords: [
    ...
    'class 9 urdu book',
    '9 class book urdu',
    'class 9th urdu book pdf',
    'class 9 urdu pdf',
    'class nine urdu book',
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 9 Urdu Book of Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download 9th Class Urdu Textbook Punjab Board</h2>
      <p>
        Here, you can download Matric class 9 Urdu Text Book in PDF Format for
