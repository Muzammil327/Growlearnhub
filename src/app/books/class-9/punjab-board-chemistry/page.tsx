...
const data = {
  title: "Class 9 Chemistry Book Punjab Board",
  description:
    "Here you can download Class 9 Chemistry Book Punjab Board in english and urdu medium. other books of class 9 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 9 chemistry books",
    "growlearnhub class 9 books chemistry",
    "class 9 chemistry",
    "class 9 chemistry english medium",
    "class 9 chemistry urdu medium",
    "class 9 chemistry book",
    "class 9 book chemistry",
    "download class 9 book chemistry",
  ],
  medium: [
    {
...
export default function page() {
  return (
    ...
    >
      ...
      <h2>Download Class 9 English Medium Chemistry Punjab Board</h2>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
      ...
      <h3>Download Class 9 Urdu Medium Chemistry Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
