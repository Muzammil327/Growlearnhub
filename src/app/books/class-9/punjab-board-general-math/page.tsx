...
const data = {
  ...
  description:
    'Here you can access class 9 General Math Book Punjab Board in english and urdu medium available in this website.',
  canonical: '/books/class-9/punjab-board-general-math/',
  index: true,
  follow: true,
  image: '/books/class-9/punjab/class-9-general-math-book-punjab-board.webp',
  ...
  keywords: [
    ...
    '9 class book general math',
    'class 9th general math book pdf',
    'class 9 general math pdf',
    'class nine general math book',
    '9th class general math book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 9 General Math Book of english and Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download Class 9 General Math Book English Medium Punjab Board</h2>
      <p>
        Here, you can download Matric class 9 General Math Text Book in PDF Format
        for English Medium. This book is officially published by Punjab Text
        Book Board.
      </p>
      <PDFViewer pdfUrl={data.english_medium} />

      <h3>Download 9th Class General Math Textbook Urdu Medium Punjab Board</h3>
      <p>
        Here, you can download Matric class 9 General Math Text Book in PDF Format
