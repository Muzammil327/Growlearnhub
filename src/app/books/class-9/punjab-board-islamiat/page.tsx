...
const data = {
  title: 'Class 9 Islamiat Book Punjab Board',
  description:
    'Here you can access class 9 Islamiat Book Punjab Board in english and urdu medium available in this website.',
  ...
  keywords: [
    ...
    '9 class book Islamiat',
    'class 9th Islamiat book pdf',
    'class 9 Islamiat pdf',
    'class nine Islamiat book',
    '9th class Islamiat book pdf',
  ],
}
...
export default function page() {
  return (
    ...
    >
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 9 Islamiat Book of Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h3>Download 9th Class Islamiat Textbook Urdu Medium Punjab Board</h3>
      <p>
