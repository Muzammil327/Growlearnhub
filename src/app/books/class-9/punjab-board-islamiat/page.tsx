...
const data = {
  ...
  description:
    "Here you can download Class 9 Islamiat Book Punjab Board in english and urdu medium. other books of class 9 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 9 Islamiat books",
    "growlearnhub class 9 books Islamiat",
    "class 9 Islamiat",
    "class 9 Islamiat english medium",
    "class 9 Islamiat urdu medium",
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 9 Urdu Medium Islamiat Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
