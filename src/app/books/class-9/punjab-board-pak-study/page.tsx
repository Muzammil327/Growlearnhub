...
const data = {
  ...
  description:
    "Here you can download Class 9 Pak Study Book Punjab Board in english and urdu medium. other books of class 9 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 9 Pak Study books",
    "growlearnhub class 9 books Pak Study",
    "class 9 Pak Study",
    "class 9 Pak Study english medium",
    "class 9 Pak Study urdu medium",
    "class 9 Pak Study book",
    "class 9 book Pak Study",
    "download class 9 book Pak Study",
  ],
  medium: [
    {
      title: "Class 9 Pak Study Punjab Board English Medium Book",
      link: "/books/class-9/punjab-board-pak-study/english/",
      description: "",
      image: "",
    },
    {
      title: "Class 9 Pak Study Punjab Board Urdu Medium Book",
      link: "/books/class-9/punjab-board-pak-study/urdu/",
      description: "",
      image: "",
    },
  ],
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 9 Urdu Medium Pak Study Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
