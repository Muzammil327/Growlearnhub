...
const data = {
  title: "Class 9 English Medium Physics Book Punjab Board",
  description:
    "Here you can download Class 9 Physics Book Punjab Board in english medium. other books of class 9 punjab board available in this platform.",
  canonical: "/books/class-9/punjab-board-physics/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-9/punjab-board-physics/english/",
  english_medium: "1my_m9qLxXF3LCw4eCFlCJGexOmsazJmg",
  keywords: [
    "growlearnhub class 9 Physics books english medium",
    "growlearnhub class 9 books Physics english medium",
    "class 9 Physics book english medium",
    "class 9 Physics english medium",
    "class 9 Physics book english medium",
    "class 9 book Physics english medium",
    "download class 9 book Physics english medium",
  ],
};
...
export default function page() {
  return (
    ...
    >
      ...
      <h2>Download Class 9 English Medium Physics Punjab Board</h2>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
