...
const data = {
  ...
  description:
    "Here you can download Class 9 Physics Book Punjab Board in english and urdu medium. other books of class 9 punjab board available in this platform.",
  ...
  keywords: [
    "growlearnhub class 9 physics books",
    "growlearnhub class 9 books physics",
    "class 9 physics",
    "class 9 physics english medium",
    "class 9 physics urdu medium",
    "class 9 physics book",
    "class 9 book physics",
    "download class 9 book physics",
  ],
  medium: [
    {
      title: "Class 9 Physics Punjab Board English Medium Book",
      link: "/books/class-9/punjab-board-physics/english/",
      description: "",
      image: "",
    },
    {
      title: "Class 9 Physics Punjab Board Urdu Medium Book",
      link: "/books/class-9/punjab-board-physics/urdu/",
      description: "",
      image: "",
    },
  ],
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 9 Urdu Medium Physics Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
