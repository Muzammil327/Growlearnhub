...
const data = {
  title: "Class 9 English Medium Math Book Punjab Board",
  description:
    "Here you can download Class 9 math Book Punjab Board in english medium. other books of class 9 punjab board available in this platform.",
  canonical: "/books/class-9/punjab-board-math/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-9/punjab-board-math/english/",
  english_medium: "1m0c4RwJH1loIwLaWurWOarhBYzncf2lQ",
  keywords: [
    "growlearnhub class 9 math books english medium",
    "growlearnhub class 9 books math english medium",
    "class 9 math book english medium",
    "class 9 math english medium",
    "class 9 math book english medium",
    "class 9 book math english medium",
    "download class 9 book math english medium",
  ],
};
