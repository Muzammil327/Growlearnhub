...
const data = {
  title: "Download Class 9 Tarjuma Tul Quran Book Punjab Board",
  description:
  ...
  keywords: [
    "growlearnhub class 9 Tarjuma Tul Quran books",
    "growlearnhub class 9 books Tarjuma Tul Quran",
    "class 9 Tarjuma Tul Quran",
    "class 9 Tarjuma Tul Quran english medium",
    "class 9 Tarjuma Tul Quran Tarjuma Tul Quran medium",
    "class 9 Tarjuma Tul Quran book",
    "class 9 book Tarjuma Tul Quran",
    "download class 9 book Tarjuma Tul Quran",
  ],
};
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 9 Tarjuma Tul Quran Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
