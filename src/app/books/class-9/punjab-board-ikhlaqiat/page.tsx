...
const data = {
  ...
  keywords: [
    "growlearnhub class 9 ikhlaqiat books",
    "growlearnhub class 9 books ikhlaqiat",
    "class 9 ikhlaqiat",
    "class 9 ikhlaqiat english medium",
    "class 9 ikhlaqiat ikhlaqiat medium",
    "class 9 ikhlaqiat book",
    "class 9 book ikhlaqiat",
    "download class 9 book ikhlaqiat",
  ],
};
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 9 ikhlaqiat Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
