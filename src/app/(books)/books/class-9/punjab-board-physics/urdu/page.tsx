...
const data = {
  title: "Download Punjab Urdu Medium Physics Book",
  description:
  ...
  canonical: "/books/class-9/punjab-board-physics/urdu/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-9/punjab-board-physics/urdu/",
        ...
        <div className="grid md:grid-cols-7 mb-28 gap-6">
          <div className="md:col-span-5">
            ...
            <h2 className="text-xl font-semibold py-3">
              Download 9th class Urdu Medium Physics Book Punjab Board
            </h2>
              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                <tbody>
                  <tr className="bg-white border-b">
                    ...
                    <td className="px-6 py-4">Physics Urdu Medium</td>
                  </tr>
                  <tr className="bg-white border-b">
            ...
            <PDFViewer pdfUrl="1_cp-urrPMokhCSCExs-B8uEujlIfqDjd" />
            <Form url={data.url} />
          </div>
