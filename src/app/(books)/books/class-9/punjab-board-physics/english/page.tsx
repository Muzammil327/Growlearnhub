...
const data = {
  title: "Download Punjab English Medium Physics Book",
  description:
        ...
        <div className="grid md:grid-cols-7 mb-28 gap-6">
          <div className="md:col-span-5">
            ...
            <h2 className="text-xl font-semibold py-3">
              Download 9th class English Medium Physics Book Punjab Board
            </h2>
              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                <tbody>
                  <tr className="bg-white border-b">
                    ...
                    <td className="px-6 py-4">Physics English Medium</td>
                  </tr>
                  <tr className="bg-white border-b">
            ...
            <PDFViewer pdfUrl="1my_m9qLxXF3LCw4eCFlCJGexOmsazJmg" />
            <Form url={data.url} />
          </div>
