...
const data = {
  title: "ISL202 Handouts Islamic Studies",
  description:
    "Here you can download Handouts OF ISL202 Islamic Studies of vu of all semester cs101, cs201, cs301, cs401 etc.",
  canonical: "/books/vu/isl202-handout/",
  index: true,
  follow: true,
  image: "/opengraph-image.jpg",
  url: "https://growlearnhub.com/books/vu/isl202-handout/",
  keywords: [
    ...
    "vu isl202 books",
    "vu isl202 handouts",
    "download isl202 handouts",
    "download vu isl202 handouts",
  ],
  list: [
    {
      id: 0,
