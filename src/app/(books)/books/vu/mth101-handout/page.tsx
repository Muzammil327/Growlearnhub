...
const data = {
  title: "MTH101 Handouts Calculus And Analytical Geometry",
  description:
    "Here you can download Handouts OF MTH101 Calculus And Analytical Geometry of vu of all semester cs101, cs201, cs301, cs401 etc.",
  canonical: "/books/vu/mth101-handout/",
  index: true,
  follow: true,
  image: "/opengraph-image.jpg",
  url: "https://growlearnhub.com/books/vu/mth101-handout/",
  keywords: [
    ...
    "vu mth101 books",
    "vu mth101 handouts",
    "download mth101 handouts",
    "download vu mth101 handouts",
  ],
  list: [
    {
      id: 0,
