...
const data = {
  title: 'VU CS101 Mid Term Abbreviation',
  description:
    'Here you can get cs101 mid term abbreviations in chapter wise and topic wise in the form of list.',
  ...
  keywords: [
    ...
    'abbreviations',
    'cs101 abbreviations',
    'mid term cs101 abbreviations',
  ],
}

export default function Page() {
  return (
    <VUWrapper title="VU CS101 Mid Term Abbreviations">
