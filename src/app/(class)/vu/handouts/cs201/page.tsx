...
const data = {
  ...
  description:
    'Here you download handouts of vu of cs201 handouts pdf, also get mid and final term assignmnet, gdb of cs101.',
  ...
  book: '1wfR97DEb1_HlAydGFbUvFFjXvH5JEscL',
}

export default function Page() {
  return (
    <VUWrapper title="VU CS201 Handouts Pdf Download">
      <div className="my-10">
        <h2>Welcome to the VU CS201 Pdf Handouts Download</h2>
        <p>
          Are you looking for a <strong>VU CS201 Handouts</strong>? You can
          download in free cs201 handouts in PDF format. Here, you can access
        ...
        <Image
          ...
          alt="VU CS201 Handouts"
          title="VU CS201 Handouts"
          height="720"
          width="1280"
        />
        <p>
        ...
        <h2 className="mt-5">Download CS201 Handouts</h2>
        <p>
          Download handouts of <strong>VU CS201 Handouts</strong> in free. Here
