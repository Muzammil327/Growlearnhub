...
const data = {
  title: 'VU CS302 Handouts Grow Learn Hub',
  description:
    'Here you download handouts of vu of cs302, also get mid and final term assignmnet, gdb of cs302.',
  ...
  book: '1-gIlWU1bzd1xunZleOZK62hYPe5lAx60',
}

export default function Page() {
  return (
    <VUWrapper title="VU CS302 Handouts Pdf Download">
      <div className="my-10">
        <h2>Welcome to the VU CS302 Pdf Handouts Download</h2>
        <p>
          Are you looking for a <strong>VU CS302 Handouts</strong>? You can
          download in free cs302 handouts in PDF format. Here, you can access
        ...
        <Image
          ...
          alt="VU CS302 Handouts"
          title="VU CS302 Handouts"
          height="720"
          width="1280"
        />
        <p>
        ...
        <h2 className="mt-5">Download CS302 Handouts</h2>
        <p>
          Download handouts of <strong>VU CS302 Handouts</strong> in free. Here
