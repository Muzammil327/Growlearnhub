...
const data = {
  title: 'Complete Guide to Class 11 | Resources and Tips for 9th Class',
  description:
    'Explore everything you need to know about Class 11 , including syllabus details, study materials, and exam preparation tips for 9th class students.',
  canonical: '/class-11/',
  index: true,
  follow: true,
  image: '/class_9.webp',
