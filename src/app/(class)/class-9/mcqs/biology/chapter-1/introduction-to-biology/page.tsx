...
const data = {
  title: '9th class Biology Mcqs Chapter 1 Introduction to Biology',
  description:
    'Here you can access 9th Class Biology Solved Mcqs Chapter 1 Introduction to Biology are available in this website.',
  canonical: '/class-9/mcqs/biology/chapter-1/introduction-to-biology/',
  index: true,
  follow: true,
  image: '/class/class-9/mcqs/biology/chapter-1/introduction-to-biology.webp',
  url: 'https://growlearnhub.com/class-9/mcqs/biology/chapter-1/introduction-to-biology/',
  keywords: [
...
export default function page() {
  return (
    <QuizWrapper
      ...
      b4="Introduction to Biology"
    >
      <p>
        Are you looking for a{' '}
        <strong>
          9th Class Biology Solved mcqs in Chapter 1 with Topic Wise of
