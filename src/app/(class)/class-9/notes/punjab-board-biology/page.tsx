...
const data = {
  title: 'Class 9 Biology Notes PDF Punjab Board',
  description:
    'Here you can access class 9 Biology Notes PDF Punjab Board in english and urdu medium available in this website.',
  canonical: '/class-9/notes/punjab-board-biology/',
  index: true,
  follow: true,
  image: '/books/class-9/punjab/class-9-physics-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-9/notes/punjab-board-biology/',
  english_medium: '1my_m9qLxXF3LCw4eCFlCJGexOmsazJmg',
  urdu_medium: '1_cp-urrPMokhCSCExs-B8uEujlIfqDjd',
  keywords: [
    '9 class notes biology',
    '9 class biology notes pdf',
    'phy class 9',
    'class 9 biology notes',
    'class 9th biology notes pdf',
    'class 9 biology pdf',
    'class nine biology notes',
  ...
  return (
    ...
    >
      <p>
        ...
        <strong>9th Class Biology notes punjab board</strong>? Here, you can
      ...
      <ImageContainer
        image={data.image}
        title="Access 9 Class Biology Notes of english and Urdu Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>Download 9th Class Biology Notes PDF English Medium Punjab Board</h2>
      <p>
        Here, you can download Matric class 9 Biology Notes in PDF Format for
        English Medium.
      </p>
