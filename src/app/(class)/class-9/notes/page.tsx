...
const data = {
  title: 'Class 9 Notes | GrowLearnHub',
  description:
    'Here you can access class 9 notes in english medium of all subjects like physics, chemistry biology and math available in this website.',
...
export default function page() {
  return (
    ...
    >
      <p>
        Are you looking for a <strong>Class 9 Notes</strong>? Here, you can
      ...
      <ImageContainer
        image={data.image}
        title="Access Class 9 Notes of all Subjects"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      {Class9_Notes.map((data: class_Book) => {
        return (
          <div key={data.name}>
            ...
            <p>
              Our collection of <strong>9th Class Notes</strong> of Punjab Baord
