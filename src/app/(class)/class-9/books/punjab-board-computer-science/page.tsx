...
const data = {
  title: 'Class 9 Computer Science Book Punjab Board',
  description:
    'Here you can download Class 9 Computer Science Book Punjab Board in english and urdu medium. other books of class 9 punjab board available in this platform.',
  canonical: '/books/class-9/punjab-board-computer-science/',
  index: true,
  follow: true,
  image:
    '/books/class-9/punjab/class-9-computer-science-book-punjab-board.webp',
  ...
  keywords: [
    'growlearnhub class 9 computer science books',
    'growlearnhub class 9 books computer science',
    'class 9 computer science',
    'class 9 computer science english medium',
    'class 9 computer science urdu medium',
...
export default function page() {
  return (
    ...
    >
      ...
      <h3>Download Class 9 Urdu Medium Computer Science Punjab Board</h3>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
