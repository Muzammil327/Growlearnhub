...
const data = {
  title: "Class 9 English Medium Computer Science Book Punjab Board",
  description:
    "Here you can download Class 9 Computer Science Book Punjab Board in english medium. other books of class 9 punjab board available in this platform.",
  canonical: "/books/class-9/punjab-board-computer-science/english/",
  index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-9/punjab-board-computer-science/english/",
  english_medium: "1o5fPLG7_lTK2sAs5smLAgJEopLTf8fsR",
  keywords: [
    "growlearnhub class 9 computer science books english medium",
    "growlearnhub class 9 books computer science english medium",
    "class 9 computer science book english medium",
    "class 9 computer science english medium",
    "class 9 computer science book english medium",
    "class 9 book computer science english medium",
    "download class 9 book computer science english medium",
  ],
};
...
export default function page() {
  return (
    ...
    >
      ...
      <h2>Download Class 9 English Medium Computer Science Punjab Board</h2>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam dolorum,
        nesciunt vel distinctio quibusdam, saepe, ducimus aspernatur quaerat
        mollitia expedita qui magnam voluptates. Cumque recusandae, quas
