...
const data = {
  title: 'Class 9 Chemistry Mcqs PDF',
  description:
    'Here you can access class 9 Chemistry Mcqs in chapter wise and topic Wise in english and urdu medium available in this website.',
  canonical: '/class-9/quiz/chemistry/',
  index: true,
  follow: true,
  image: '/books/class-9/punjab/class-9-physics-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-9/quiz/chemistry/',
  keywords: [
    '9 class quiz chemistry',
    '9 class chemistry quiz pdf',
    'phy class 9',
    'class 9 chemistry quiz',
    'class 9th chemistry quiz pdf',
    'class 9 chemistry pdf',
    'class nine chemistry quiz',
    '9th class chemistry quiz pdf',
  ],
}
  ...
  return (
    ...
    >
      <p>
        ...
        <strong>9th Class Chemistry quiz in Chapter Wise and Topic Wise</strong>?
      ...
      <ImageContainer
        image={data.image}
        title="Access 9th Class Chemistry Mcqs of english Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>9th Class Chemistry Quiz English Medium</h2>
      <p>Here, you can read Matric class 9 Chemistry Mcqs for English Medium.</p>
