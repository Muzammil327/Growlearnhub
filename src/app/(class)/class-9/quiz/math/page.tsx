...
const data = {
  title: 'Class 9 Math Mcqs PDF',
  description:
    'Here you can access class 9 Math Mcqs in chapter wise and topic Wise in english and urdu medium available in this website.',
  canonical: '/class-9/quiz/math/',
  index: true,
  follow: true,
  image: '/books/class-9/punjab/class-9-physics-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-9/quiz/math/',
  keywords: [
    '9 class quiz math',
    '9 class math quiz pdf',
    'phy class 9',
    'class 9 math quiz',
    'class 9th math quiz pdf',
    'class 9 math pdf',
    'class nine math quiz',
    '9th class math quiz pdf',
  ],
}
  ...
  return (
    ...
    >
      <p>
        ...
        <strong>9th Class Math quiz in Chapter Wise and Topic Wise</strong>?
      ...
      <ImageContainer
        image={data.image}
        title="Access 9th Class Math Mcqs of english Medium"
        class="my-4 w-full"
        height={720}
        width={1280}
        priority
      ...
      <h2>9th Class Math Quiz English Medium</h2>
      <p>Here, you can read Matric class 9 Math Mcqs for English Medium.</p>
