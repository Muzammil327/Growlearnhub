...
export const GetTag = `${URL}/api/get/tags`
export const DeleteTag = `${URL}/api/delete/tags`
export const GetSingleTags = `${URL}/api/get/stags`
export const PostTags = `${URL}/api/post/tags`
export const UpdateTags = `${URL}/api/update/tags`
