...
export default function Page() {
  return (
    <SimpleWrapper data={data}>
      ...
      <Heading2 variant="black">Subjects Covered for Class 9</Heading2>
      <UnorderedList
        items={[
          { description: "Physics" },
      ...
      <Heading3 variant="black">Online Tests for Class 9:</Heading3>
      <p className="p5">
      ...
      />
      <Heading3 variant="black">Past Papers for Class 9:</Heading3>
      <p className="p5">
