...
const data = {
  title: "9th Class Chemistry Book Pdf Download - Punjab Board (Urdu Medium)",
  description:
    "Access the 9th class Chemistry textbook (Urdu medium) for Punjab Board. Ideal for thorough understanding and exam readiness. Download your PDF now!",
  canonical: "/class-9/books/punjab-board-chemistry/urdu-medium/",
  index: true,
  follow: true,
  image: "/9th/book/punjab/class-9-chemistry-book-punjab-board.webp",
  url: "https://growlearnhub.com/class-9/books/punjab-board-chemistry/urdu-medium/",
  keywords: [
    ...
    "chemistry 9th Class Book Urdu Medium PDF Download Punjab Board"
  ],
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <strong>Chemistry 9th Class Book Urdu Medium PDF </strong>
