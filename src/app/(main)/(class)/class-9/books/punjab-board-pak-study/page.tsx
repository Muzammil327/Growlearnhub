...
//               pak study, Economics, Tarjuma Tul Quran, Ikhlaqiat,
...
const data = {
  title: 'Pak Study Class 9 Book PDF | 9th Class Punjab Text Book',
  description:
...
export default function Page() {
  return (
    ...
    >
        ...
        {mainData.map((data: any) => {
          return (
            <CardSmall
              key={data.name}
              title={data.name}
              link={`/class-9/books/punjab-board-pak-study/${data.slug}-medium/`}
            />
          )
        })}
      </div>
      ...
      <h3>Download Class 9 Pak Study Book English Medium Punjab Board</h3>
      <p>
        Here, you can download Matric class 9 Pak Study Text Book in PDF Format
        for English Medium. This book is officially published by Punjab Text
        Book Board.
...
const mainData = [
  {
    name: 'Class 9 Pak Study Book PDF Punjab Board English Medium',
    slug: 'english',
  },
  {
    name: 'Pak Study Class 9 Punjab Board Text Book PDF Urdu Medium',
    slug: 'urdu',
  },
]
