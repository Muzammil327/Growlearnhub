...
const data = {
  title:
    '9th Class General Math Book PDF English Medium Free Download | Punjab Boards',
  description:
    'Download the 9th Class General Math Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  canonical: '/class-9/books/punjab-board-general-math/english-medium/',
  index: true,
  follow: true,
  image: '/9th/book/punjab/class-9-general-math-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-9/books/punjab-board-general-math/english-medium/',
  keywords: [
    ...
    '9th Class general math Book PDF English Medium Free Download',
    'class 9 general math book punjab board',
    'punjab text book general math 9th class pdf english medium',
  ],
...
export default function Page() {
  return (
    <Wrapper
      title={data.title}
      url={data.canonical}
      b1="Punjab Board General Math"
      b1Link="/class-9/books/punjab-board-general-math/"
      b2="English Medium"
      image={data.image}
      clist={data.clist}
    >
      <h3>
        General Math 9th Class Book English Medium PDF Download Punjab Board
      </h3>
      <p>
      ...
      <table className="relative w-full">
        <thead>
          <tr className="bg-white border-b hover:bg-slate-100">
            ...
            >
              Chapter Wise Download General Math Book
            </th>
            ...
            return (
              ...
              >
                <th
                  ...
                  className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap"
                >
                  Chapter {data.id} General Math Book
                </th>
      ...
      <p>
        ...
        <strong>General Math 9th Class Book English Medium PDF </strong>
