...
const data = {
  title:
    '9th Class Computer Science Book PDF English Medium Free Download | Punjab Boards',
  description:
...
export default function Page() {
  return (
    <Wrapper
      ...
      clist={data.clist}
    >
      <h3>Computer Science 9th Class Book English Medium PDF Download Punjab Board</h3>
      <p>
        Are you looking for a <strong>Class 9 computer science book punjab board</strong>
