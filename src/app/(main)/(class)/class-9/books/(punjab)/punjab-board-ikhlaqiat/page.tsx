...
const data = {
  title: "Class 9 Punjab Board Ikhlaqiat Books PDF Download",
  description: "",
  canonical: "/class-9/books/punjab-board-ikhlaqiat/",
  index: true,
  follow: true,
  image: "/book_point/class_9/class_9_punjab_board_ikhlaqiat_book.webp",
  ...
  return (
    <SimpleWrapper data={data}>
      ...
      <Heading2 variant="black">
        Download 9th Class Ikhlaqiat Textbook Punjab Board
      </Heading2>
      <p className="p5">
