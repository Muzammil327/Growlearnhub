...
const data = {
  title: "Class 9 Punjab Board English Books PDF Download",
  description: "",
  canonical: "/class-9/books/punjab-board-english/",
  index: true,
  follow: true,
  image: "/book_point/class_9/class_9_punjab_board_english_book.webp",
    ...
    <SimpleWrapper data={data}>
      <div className="grid gap-4 grid-cols-1 my-10">
        <p className="p5">
          ...
          <strong>Class 9 english book punjab board</strong>? Here, you can
      ...
      <Heading2 variant="black">
        Download 9th Class English Textbook Punjab Board
      </Heading2>
      <p className="p5">
