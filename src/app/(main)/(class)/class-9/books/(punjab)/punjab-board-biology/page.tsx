...
const data = {
  title: "Class 9 Punjab Board Biology Books PDF Download",
  description: "",
    ...
    <SimpleWrapper data={data}>
      <div className="grid gap-4 grid-cols-1 my-10">
        <p className="p5">
          ...
          <strong>Class 9 biology book punjab board</strong>? Here, you can
      ...
      <Heading2 variant="black">Download Class 9 Biology Book English Medium Punjab Board</Heading2>
      <p className="p5">
      ...
      <Heading2 variant="black">Download 9th Class Biology Textbook Urdu Medium Punjab Board</Heading2>
      <p className="p5">
        Here, you can download Matric class 9 Biology Text Book in PDF Format
