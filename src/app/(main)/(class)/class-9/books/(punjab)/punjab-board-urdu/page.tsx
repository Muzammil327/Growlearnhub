...
const data = {
  title: "Class 9 Punjab Board Urdu Books PDF Download",
  description: "",
  canonical: "/class-9/books/punjab-board-urdu/",
  index: true,
  follow: true,
  image: "/book_point/class_9/class_9_punjab_board_urdu_book.webp",
  url: "https://growlearnhub.com/class-9/books/punjab-board-urdu/",
  keywords: [
    "urdu tul quran class 9 punjab text book pdf",
    "class 9 urdu tul quran book pdf punjab board",
    "9th class urdu tul quran punjab text book",
    "urdu tul quran book class 9 punjab board",
    "class 9 urdu tul quran book punjab board"
  ],
  ...
  return (
    <SimpleWrapper data={data}>
      ...
      <Heading2 variant="black">
        Download 9th Class Urdu Textbook Punjab Board
      </Heading2>
      <p className="p5">
