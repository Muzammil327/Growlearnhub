...
const data = {
  title: "Islamiyat Class 9 Book PDF | 9th Class Punjab Text Book",
  description:
    "Download the official Islamiyat Class 9 textbook PDF by Punjab Board. This comprehensive guide covers the entire syllabus with clear explanation.",
...
export default function Page() {
  return (
    <SimpleWrapper data={data}>
      ...
      <h3>Download Class 9 Islamiyat Book Punjab Board</h3>
      <MutedPara>
