...
const data = {
  ...
  index: true,
  follow: true,
  image: '/class/vu/handouts/pak301_handouts.webp',
  url: 'https://growlearnhub.com/vu/handouts/pak301/',
  keywords: [
    'growlearnhub',
    'vu pak301 handouts',
    'growlearnhub pak301 handouts',
    'pak301 handouts',
    'virtual university pak301 handouts',
  ],
  clist: [
