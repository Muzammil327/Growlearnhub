...
import VUHighlightedHandoutWrapper from "@/src/app/(main)/(class)/vu/highlight-handouts/VUHighlightedHandoutWrapper"
...
export default function Page() {
  return (
    <VUHighlightedHandoutWrapper data={data}>
      <p className="p5">
        Welcome to your one-stop source for <em>ENG201 Handouts</em> from
        <LinkComponent slug="https://www.vu.edu.pk/"> Virtual University (VU)</LinkComponent>.
        Download the handouts in PDF format for free and study at your own pace.
      </p>

      {/* PDF Viewer  */}
      <Heading3 variant="black">Download ENG201 Handouts PDF</Heading3>
      <p className="p5">
      ...
      {/* Table  */}
      <Heading3 variant="black">Topics Covered in ENG201 Handouts</Heading3>
      <p className="p5">
