...
export async function generateMetadata({ params }: PageProps) {
  ...
  try {
    ...
    let description = "Class 10" + " " + SlugRemoveDashAndUppercase + " " + "Online Test page offering a wide range of practice questions, online tests, and detailed answers for thorough exam preparation.";
    let keywords = [
