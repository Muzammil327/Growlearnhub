...
export async function generateMetadata({ params }: PageProps) {
  ...
  let url = `${process.env.NEXT_PUBLIC_SITE_URL}/class-10/online-test/${slug1}/${slug2}/`;
  let canonical = `/class-10/online-test/${slug1}/${slug2}/`;

  try {

    let title = "Class 10 " + SlugRemoveDashAndUppercase1 + " " + SlugRemoveDashAndUppercase2 + " " + "Online Test";
    let description = "Class 10" + " " + SlugRemoveDashAndUppercase1 + " " + SlugRemoveDashAndUppercase2 + " " + "Online Test page offering a wide range of practice questions, online tests, and detailed answers for thorough exam preparation.";
    let keywords = [
