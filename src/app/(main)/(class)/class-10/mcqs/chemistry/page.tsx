...
const data = {
  ...
  description:
    'Class 10 Chemistry MCQs page offering a wide range of practice questions, online tests, and detailed answers for thorough exam preparation.',
  ...
  keywords: [
    ...
    'growlearnhub class 10 chemistry mcqs',
