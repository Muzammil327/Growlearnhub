...
const data = {
  title: '10th Class General Math Book PDF Urdu Medium Download | Punjab',
  description:
    'Download the 10th Class General Math Book PDF in Urdu Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  canonical: '/class-10/books/punjab-board-general-math/urdu-medium/',
  index: true,
  follow: true,
  image: '/10th/book/punjab/class-10-general-math-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-10/books/punjab-board-general-math/urdu-medium/',
  keywords: [
    ...
    '10th Class general math Book PDF urdu Medium Free Download',
    'class 10 general math book punjab board',
    'punjab text book general math 10th class pdf urdu medium',
  ],
...
export default function Page() {
  return (
    <Wrapper
      ...
      b1Link="/class-10/books/punjab-board-general-math/"
      b2="Urdu Medium"
      image={data.image}
      clist={data.clist}
    >
      <h3>
        General Math 10th Class Book Urdu Medium PDF Download Punjab Board
      </h3>
      <p>
      ...
      <p>
        ...
        <strong>General Math 10th Class Book Urdu Medium PDF </strong>
