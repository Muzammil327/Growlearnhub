...
const data = {
  title:
    '10th General Math Book PDF English Medium Download | Punjab',
  description:
    'Download the 10th Class General Math Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  ...
  keywords: [
    ...
    '10th Class general math Book PDF English Medium Free Download',
    'class 10 general math book punjab board',
    'punjab text book general math 10th class pdf english medium',
  ],
...
export default function Page() {
  return (
    ...
    >
      <h3>
        General Math 10th Class Book English Medium PDF Download Punjab Board
      </h3>
      <p>
      ...
      <p>
        ...
        <strong>General Math 10th Class Book English Medium PDF </strong>
