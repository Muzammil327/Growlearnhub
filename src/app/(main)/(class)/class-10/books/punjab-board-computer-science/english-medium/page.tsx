...
const data = {
  title: '10th Computer Science Book PDF English Medium Download | Punjab',
  description:
    'Download the 10th Class Computer Science Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  ...
  keywords: [
    ...
    '10th Class computer science Book PDF English Medium Free Download',
    'class 10 computer science book punjab board',
    'punjab text book computer science 10th class pdf english medium',
  ],
...
export default function Page() {
  return (
    ...
    >
      <h3>
        Computer Science 10th Class Book English Medium PDF Download Punjab
        Board
      </h3>
      <p>
      ...
      <p>
        ...
        <strong>Computer Science 10th Class Book English Medium PDF </strong>
