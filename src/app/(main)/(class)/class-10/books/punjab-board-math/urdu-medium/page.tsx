...
const data = {
  title: 'Math 10th Class Book Urdu Medium PDF Download | Punjab Board',
  description:
    'Download the 10th Class Math Book PDF in Urdu Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  canonical: '/class-10/books/punjab-board-math/urdu-medium/',
  index: true,
  follow: true,
  image: '/10th/book/punjab/class-10-math-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-10/books/punjab-board-math/urdu-medium/',
  keywords: [
    ...
    'math 10th Class Book Urdu Medium PDF Download Punjab Board',
  ],
...
export default function Page() {
  return (
    <Wrapper
      ...
      clist={data.clist}
    >
      <h3>Math 10th Class Book Urdu Medium PDF Download Punjab Board</h3>
      <p>
      ...
      <p>
        ...
        <strong>Math 10th Class Book Urdu Medium PDF </strong>
