...
const data = {
  title:
    '10th Class Math Book PDF English Medium Free Download | Punjab Boards',
  description:
    'Download the 10th Class Math Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  canonical: '/class-10/books/punjab-board-math/english-medium/',
  index: true,
  follow: true,
  image: '/10th/book/punjab/class-10-math-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-10/books/punjab-board-math/english-medium/',
  keywords: [
    ...
    '10th Class math Book PDF English Medium Free Download',
    'class 10 math book punjab board',
    'punjab text book math 10th class pdf english medium',
  ],
...
export default function Page() {
  return (
    <SimpleWrapper
      ...
      b1Link="/class-10/books/punjab-board-math/"
      b2="English Medium"
      image={data.image}
      clist={data.clist}
    >
      <h3>Math 10th Class Book English Medium PDF Download Punjab Board</h3>
      <p>
      ...
      <p>
        ...
        <strong>Math 10th Class Book English Medium PDF </strong>
