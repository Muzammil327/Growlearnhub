...
const data = {
  ...
  keywords: [],
  image: "/10th/book/punjab/class_10_general-math_book_punjab_board.webp",
  canonical: "/class-10/books/punjab-board-general-math/urdu-medium/",
  url: "https://www.growlearnhub.com/class-10/books/punjab-board-general-math/urdu-medium/",
  index: true,
  follow: true,
};
