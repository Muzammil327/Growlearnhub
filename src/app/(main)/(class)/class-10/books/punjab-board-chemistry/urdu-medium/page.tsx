...
const data = {
  title: '10th Class Chemistry Book PDF Urdu Medium Download | Punjab',
  description:
    'Download the 10th Class Chemistry Book PDF in Urdu Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  ...
  url: 'https://growlearnhub.com/class-10/books/punjab-board-chemistry/urdu-medium/',
  keywords: [
    ...
    'chemistry 10th Class Book Urdu Medium PDF Download Punjab Board',
  ],
  fileId_urdu: '1oXj4uREnP4i8CnwYyemPaQn-kbaJhuRw',
  clist: [
...
export default function Page() {
  return (
    <Wrapper
      ...
      b1Link="/class-10/books/punjab-board-chemistry/"
      b2="Urdu Medium"
      image={data.image}
      clist={data.clist}
    >
      <h3>Chemistry 10th Class Book Urdu Medium PDF Download Punjab Board</h3>
      <p>
      ...
      <p>
        ...
        <strong>Chemistry 10th Class Book Urdu Medium PDF </strong>
