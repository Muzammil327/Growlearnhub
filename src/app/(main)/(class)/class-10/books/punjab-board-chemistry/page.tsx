...
const data = {
  title: 'Chemistry Class 10 Book PDF | 10th Class Punjab Text Book',
  description:
...
export default function Page() {
  return (
    ...
    >
      ...
      <h3>Download Class 10 Chemistry Book English Medium Punjab Board</h3>
      <p>
...
const mainData = [
  ...
  {
    name: 'Chemistry Class 10 Punjab Board Text Book PDF Urdu Medium',
    slug: 'urdu',
  },
]
