...
const data = {
  title: 'Tarjuma Tul Quran Class 10 Book PDF | 10th Class',
  description:
  ...
  index: true,
  follow: true,
  image: '/10th/book/punjab/class-10-tarjuma-tul-quran-book-punjab-board.webp',
  ...
  fileId_urdu: '1Xpz8531xWZqeqCo0rD9fUskHsEsZv7nI',
  clist: [
...
export default function Page() {
  return (
    ...
    >
      <p>
        Are you looking for a <strong>Class 10 tarjuma tul quran book punjab board</strong>
      ...
      <p>
        Here, you can download Matric class 10 Tarjuma Tul Quran Text Book in PDF Format.
