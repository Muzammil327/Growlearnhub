...
const data = {
  title: '10th Physics Book PDF English Medium Download | Punjab',
  description:
    'Download the 10th Class Physics Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  canonical: '/class-10/books/punjab-board-physics/english-medium/',
  index: true,
  follow: true,
  image: '/10th/book/punjab/class-10-physics-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-10/books/punjab-board-physics/english-medium/',
  keywords: [
    ...
    '10th Class physics Book PDF English Medium Free Download',
    'class 10 physics book punjab board',
    'punjab text book physics 10th class pdf english medium',
  ],
  fileId_english: '1w4B4C1PmS6pB2iWTh1K9EQf_HAG8Ohsx',
  clist: [
...
export default function Page() {
  return (
    <SimpleWrapper
      ...
      b1Link="/class-10/books/punjab-board-physics/"
      b2="English Medium"
      image={data.image}
      clist={data.clist}
    >
      <h3>Physics 10th Class Book English Medium PDF Download Punjab Board</h3>
      <p>
        Are you looking for a{' '}
        <strong>Class 10 physics book punjab board</strong>? Here, you can
      ...
      <p>
        ...
        <strong>Physics 10th Class Book English Medium PDF </strong>
