...
const data = {
  title: '10th Class Physics Book PDF Urdu Medium Download | Punjab',
  description:
    'Download the 10th Class Physics Book PDF in Urdu Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  canonical: '/class-10/books/punjab-board-physics/urdu-medium/',
  index: true,
  follow: true,
  image: '/10th/book/punjab/class-10-physics-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-10/books/punjab-board-physics/urdu-medium/',
  keywords: [
    ...
    'physics 10th Class Book Urdu Medium PDF Download Punjab Board',
  ],
  fileId_urdu: '14NI-_nE6bg3YjcAl0pycYNKvenS2vOgD',
  clist: [
...
export default function Page() {
  return (
    <Wrapper
      ...
      clist={data.clist}
    >
      <h3>Physics 10th Class Book Urdu Medium PDF Download Punjab Board</h3>
      <p>
      ...
      <p>
        ...
        <strong>Physics 10th Class Book Urdu Medium PDF </strong>
