...
const data = {
  ...
  url: "https://www.growlearnhub.com/class-12/books/punjab-board-physics/",
  index: true,
  follow: true,
  ...
  return (
    <SimpleWrapper data={data}>
      ...
      <MutedPara>
        ...
        <strong>Class 12 physics book punjab board</strong>? Here, you can
        access all the books you need for free. Our website offers a complete
        collection of books for students in Class 9, , 11, and 12. Whether
