...
const data = {
  title:
    '12th Class Biology Book PDF English Medium Free Download | Punjab Boards',
  description:
    'Download the 12th Class Biology Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads, along with other Class 12 books in both English and Urdu mediums.',
  canonical: '/class-12/books/punjab-board-biology/english-medium/',
  index: true,
  follow: true,
  image: '/books/class-12/punjab/class-12-biology-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-12/books/punjab-board-biology/english-medium/',
  keywords: [
    ...
    '12th Class Biology Book PDF English Medium Free Download',
    'class 12 biology book punjab board',
    'punjab text book biology 12th class pdf english medium',
  ],
...
export default function Page() {
  return (
    <Wrapper
      ...
      b3Link="/class-12/books/punjab-board-biology/"
      b4="Biology 12th Class Book English Medium"
      image={data.image}
      clist={data.clist}
    >
      <h3>Biology 12th Class Book English Medium PDF Download Punjab Board</h3>
      <p>
        Are you looking for a <strong>Class 12 biology book punjab board</strong>
        ? Here, you can access all the books of class 12 you need for free. Our
      ...
      <p>
        ...
        <strong>Biology 12th Class Book English Medium PDF </strong>
              ...
              {data.child.map((data: any) => {
                return (
                  <CardSmall
                    key={data.name}
                    title={data.name}
                    link={`/class-12/books/punjab-board-${data.slug}`}
                  />
                )
              })}
            </div>
