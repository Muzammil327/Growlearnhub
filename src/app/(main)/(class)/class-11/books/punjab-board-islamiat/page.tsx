...
const data = {
  ...
  description:
    'Download the official Islamiat Class 11 textbook PDF by Punjab Board. This comprehensive guide covers the entire syllabus with clear explanation.',
  canonical: '/class-11/books/punjab-board-islamiat/',
  index: true,
  follow: true,
  image: '/11th/book/punjab/class-11-Islamiat-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-11/books/punjab-board-islamiat/',
  keywords: [
    'islamiat class 11 punjab text book pdf',
...
export default function Page() {
  return (
    <SimpleWrapper
      ...
      b2="Punjab Board Islamiat"
      image={data.image}
      clist={data.clist}
    >
      <p>
        Are you looking for a <strong>Class 11 islamiat book punjab board</strong>
      ...
      <h3>Download Class 11 Islamiat Book Punjab Board</h3>
      <p>
        Here, you can download Matric class 11 Islamiat Text Book in PDF Format.
