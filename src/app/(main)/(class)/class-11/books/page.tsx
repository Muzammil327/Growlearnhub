...
const data = {
  ...
  index: true,
  follow: true,
  image: "/book_point/class_11_books.webp",
  url: "https://growlearnhub.com/class-11/books/",
  keywords: ["growlearnhub", "growlearnhub book", "class 11 books"],
  breadcrumbs: [
    { title: "Home", link: "/" },
...
export default function Page() {
  return (
    <SimpleWrapper data={data}>
      <Heading2 variant="black">Class 11 Books</Heading2>
      <div className="grid gap-4 md:grid-cols-2 grid-cols-1 my-10">
        {MainDataClass12Book.map((data: {
          title: string
          child: {
            name: string
            slug: string
