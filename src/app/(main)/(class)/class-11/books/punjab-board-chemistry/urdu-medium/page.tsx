...
const data = {
  title: '11th Class Chemistry Book PDF Urdu Medium Download | Punjab',
  description:
    'Download the 11th Class Chemistry Book PDF in Urdu Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  canonical: '/class-11/books/punjab-board-chemistry/urdu-medium/',
  index: true,
  follow: true,
  image: '/11th/book/punjab/class-11-chemistry-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-11/books/punjab-board-chemistry/urdu-medium/',
  keywords: [
    ...
    'chemistry 11th Class Book Urdu Medium PDF Download Punjab Board',
  ],
...
export default function Page() {
  return (
    <Wrapper
      ...
      clist={data.clist}
    >
      <h3>Chemistry 11th Class Book Urdu Medium PDF Download Punjab Board</h3>
      <p>
      ...
      <p>
        ...
        <strong>Chemistry 11th Class Book Urdu Medium PDF </strong>
