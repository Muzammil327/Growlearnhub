...
const data = {
  title: "11th Chemistry Book PDF English Medium Download | Punjab",
  description:
    "Download the 11th Class Chemistry Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.",
  canonical: "/class-11/books/punjab-board-chemistry/english-medium/",
  index: true,
  follow: true,
  image: "/11th/book/punjab/class-11-chemistry-book-punjab-board.webp",
  url: "https://growlearnhub.com/class-11/books/punjab-board-chemistry/english-medium/",
  keywords: [
    ...
    "11th Class chemistry Book PDF English Medium Free Download",
    "class 11 chemistry book punjab board",
    "punjab text book chemistry 11th class pdf english medium"
  ],
...
export default function Page() {
  return (
    <SimpleWrapper
      ...
      b1Link="/class-11/books/punjab-board-chemistry/"
      b2="English Medium"
      image={data.image}
      clist={data.clist}
    >
      <h3>Chemistry 11th Class Book English Medium PDF Download Punjab Board</h3>
      <p>
      ...
      <p>
        ...
        <strong>Chemistry 11th Class Book English Medium PDF </strong>
