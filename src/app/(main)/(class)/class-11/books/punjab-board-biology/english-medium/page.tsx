...
const data = {
  title:
    '11th Class Biology Book PDF English Medium Free Download | Punjab Boards',
  description:
    'Download the 11th Class Biology Book PDF in English Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads, along with other Class 11 books in both English and Urdu mediums.',
  canonical: '/class-11/books/punjab-board-biology/english-medium/',
  index: true,
  follow: true,
  image: '/books/class-11/punjab/class-11-biology-book-punjab-board.webp',
  url: 'https://growlearnhub.com/class-11/books/punjab-board-biology/english-medium/',
  keywords: [
    ...
    '11th Class Biology Book PDF English Medium Free Download',
    'class 11 biology book punjab board',
    'punjab text book biology 11th class pdf english medium',
  ],
...
export default function Page() {
  return (
    <Wrapper
      ...
      b4="Biology 11th Class Book English Medium"
      image={data.image}
      clist={data.clist}
    >
      ...
      <p>
        ...
        <strong>Biology 11th Class Book English Medium PDF </strong>
              ...
              {data.child.map((data: any) => {
                return (
                  <CardSmall
                    key={data.name}
                    title={data.name}
                    link={`/class-11/books/punjab-board-${data.slug}`}
                  />
                )
              })}
            </div>
