...
const data = {
  title: '11th Class Biology Book PDF Urdu Medium Download | Punjab',
  description:
    'Download the 11th Class Biology Book PDF in Urdu Medium for free. Get the Punjab Board-approved textbook and explore chapter-wise downloads.',
  ...
  keywords: [
    ...
    'Biology 11th Class Book Urdu Medium PDF Download Punjab Board',
  ],
