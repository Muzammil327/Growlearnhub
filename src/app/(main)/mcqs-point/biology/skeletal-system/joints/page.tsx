...
import { BiologyMcqsSkeletalSystemJointsMcqs } from '@/src/app/(main)/mcqs-point/biology/skeletal-system/joints/data'

const data = {
  title: 'Joints Skeletal System Biology Mcqs',
  description:
  ...
  canonical: '/mcqs-point/biology/skeletal-system/joints/',
  index: true,
  follow: true,
  image: '/mcqs-point/general-knowledge/general-knowledge-quiz.png',
  url: 'https://growlearnhub.com/mcqs-point/biology/skeletal-system/joints/',
  ...
  return (
    ...
    >
      <div className="my-10 grid gap-4">
        {BiologyMcqsSkeletalSystemJointsMcqs.map((book: any) => (
          <CardQuiz
            key={book.id}
            title={book.name}
