...
const data = {
  title: "Download Punjab Urdu Medium Computer Science Book",
  description:
    ...
    canonical: "/books/class-9/punjab-board-computer-science/urdu/",
    index: true,
  follow: true,
  image: "/9th/book/biology/Download-Punjab-Board-Biology-Book.webp",
  url: "https://growlearnhub.com/books/class-9/punjab-board-computer-science/urdu/",
        ...
        <div className="grid md:grid-cols-7 mb-28 gap-6">
          <div className="md:col-span-5">
            ...
            <h2 className="text-xl font-semibold py-3">
              Download 9th class Urdu Medium Computer Science Book Punjab Board
            </h2>
              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                <tbody>
                  <tr className="bg-white border-b">
                    ...
                    <td className="px-6 py-4">Computer Science Urdu Medium</td>
                  </tr>
                  <tr className="bg-white border-b">
            ...
            <PDFViewer pdfUrl="1dSyB9KxtY59L541KRu55BmWEVbmy6rnz" />
            <Form url={data.url} />
          </div>
